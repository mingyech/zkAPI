...
// Development deployments and tests can use a smaller tree (height-20 keygen
// is impractical for short-lived environments); production operators publish
// roots for their configured height. Cryptographic soundness comes from
